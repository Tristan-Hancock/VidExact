...
# Combine text columns into single document per scene
...
joblib.dump({'scene_vectors': scene_vectors, 'metadata': df[['clip_name', 'timestamp_start', 'timestamp_end']]}, INDEX_PATH)
