...
df = pd.read_csv('../output/csv/final_results.csv')
...
search_df.to_csv('../output/csv/search_index.csv', index=False)

print(f"Cleaned search index saved to '../output/csv/search_index.csv' ({len(search_df)} rows)")
